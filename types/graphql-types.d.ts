...
export type SitePageContextNode = {
  node?: Maybe<SitePageContextNodeNode>;
};

export type SitePageContextNodeFilterInput = {
  node?: Maybe<SitePageContextNodeNodeFilterInput>;
};

export type SitePageContextNodeNode = {
  frontmatter?: Maybe<SitePageContextNodeNodeFrontmatter>;
  html?: Maybe<Scalars['String']>;
};

export type SitePageContextNodeNodeFilterInput = {
  frontmatter?: Maybe<SitePageContextNodeNodeFrontmatterFilterInput>;
  html?: Maybe<StringQueryOperatorInput>;
};

export type SitePageContextNodeNodeFrontmatter = {
  slug?: Maybe<Scalars['String']>;
  date?: Maybe<Scalars['Date']>;
  title?: Maybe<Scalars['String']>;
};

export type SitePageContextNodeNodeFrontmatterFilterInput = {
  slug?: Maybe<StringQueryOperatorInput>;
  date?: Maybe<DateQueryOperatorInput>;
  title?: Maybe<StringQueryOperatorInput>;
};
